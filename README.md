...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-luacbps.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-luacbps.containers.anotherwebservice.com/
...
```
git clone git@github.com:BigSam8/container-luacbps.git
cd container-luacbps
```
...
```
docker attach container-luacbps
```
